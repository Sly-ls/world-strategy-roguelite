...
static func _check_distance_to_poi(condition: Dictionary) -> bool:
	...
	var poi_type: GameEnums.CellType = condition.get("poi_type", GameEnums.CellType.PLAINE)
...
static func distance_to_poi(poi_type: GameEnums.CellType, min_dist: int = 0, max_dist: int = 9999) -> Dictionary:
