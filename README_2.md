...
Ce dossier **game_design_doc_recup** contient l'ensemble des documents détaillés, exploratoires ou alternatifs produits au fil du développement.  
...
### **01 – World Map**
👉 [01_world_map.md](documentations/game_design_doc_recup/01_world_map.md)  
...
👉 [09_combat.md](documentations/game_design_doc_recup/09_combat.md)  
Version améliorée du combat tactique, intégrant nouvelles mécaniques et règles.

---

### **10 – Ressources, logistique & repos**
👉 [10_ressources_logistique_repos.md](documentations/game_design_doc_recup/10_ressources_logistique_repos.md)  
Fonctionnement détaillé : nourriture, logistique, chariots, repos, moral, soins.

---

### **11 – Interface utilisateur (IHM)**
👉 [11_IHM.md](documentations/game_design_doc_recup/11_IHM.md)  
Wireframes, maquettes et principes d'interface (world map + combat + menus).

---

### **12 – Architecture logicielle**
👉 [12_architecture_logicielle.md](documentations/game_design_doc_recup/12_architecture_logicielle.md)  
Structure globale du projet, organisation des systèmes, communication entre modules.

---

### **13 – Roadmap détaillée**
👉 [13_roadmap_dev.md](documentations/game_design_doc_recup/13_roadmap_dev.md)  
Roadmap complète sur plusieurs phases, objectifs et jalons.

---

### **14 – Roadmap simplifiée**
👉 [14_roadmap_simp.md](documentations/game_design_doc_recup/14_roadmap_simp.md)  
Version synthétique de la roadmap pour vision rapide du développement.

---

### **15 – Première roadmap**
👉 [15_first_roadmap.md](documentations/game_design_doc_recup/15_first_roadmap.md)  
Première ébauche historique de la roadmap initiale du projet.

---

### **16 – Fiche technique**
👉 [16_fiche_technique.md](documentations/game_design_doc_recup/16_fiche_technique.md)  
Synthèse des specs techniques, contraintes, formats, pipelines.

---

### **17 – Notes diverses**
👉 [17_others.md](documentations/game_design_doc_recup/17_others.md)  
